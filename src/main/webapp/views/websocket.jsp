    ...
    let websocket = {
        ...
        connect:function(){
            ...
            this.stompClient.connect({}, function(frame) {
                ...
                /*
                    subscribe = 받을준비(연결하고나면 받을 준비를 한다) send라고 보내면 ('/send')가(아래 애)가 받아서 처리하겠다. 메시지를 받아서 출력하겠다.
                */
                ...
                /*
                    sever에서 나의 id 보냈으면 나한테만 메시지가 온다
                    메시지를 화면에 출력한다.
                */
        ...
        sendAll:function(){
            ...
            //receiveall에게 메세지를 전송한다(msg controller 로 간다)
