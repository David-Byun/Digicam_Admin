    ...
    let websocket_center = {
        ...
        connect:function(){
            ...
            this.stompClient.connect({}, function(frame) {
                ...
                console.log('Connected: ' + frame);                    //connect가 일어나면
                this.subscribe('/sendadm', function(msg) {             //받을준비
                    $('#content1_msg').text(JSON.parse(msg.body).content1);   //msg객체를 꺼내서 content1을 꺼냄
                    ...
                    $('#progress1').css('width', JSON.parse(msg.body).content1*10 +'%');
                    $('#progress1').attr('aria-valuenow', JSON.parse(msg.body).content1*10 );

                    $('#progress2').css('width', JSON.parse(msg.body).content2 +'%');
...
<div class="container-fluid">
    ...
    <div class="row">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div id="progress1" class="progress-bar bg-danger" role="progressbar"
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-seccess shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div id="progres4" class="progress-bar bg-secondary" role="progressbar"
                                             style="width: 50%" aria-valuenow="50" aria-valuemin="0"
                                             aria-valuemax="100"></div>
                                    </div>
                                </div>
